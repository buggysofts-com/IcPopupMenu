...
package com.ruet_cse_1503050.ragib.icpopupmenu;
...
/**
 * Custom Static library support version of the framework's {@link android.widget.PopupMenu}.
 * Used to write apps that run on platforms prior to Android 3.0.  When running
 * on Android 3.0 or above, this implementation is still used; it does not try
 * to switch to the framework's implementation. See the framework SDK
 * documentation for a class overview.
 */
public class IcPopupMenu {
     ...
     */
    public IcPopupMenu(@NonNull Context context, @NonNull View anchor) {
     ...
     *        anchor.
     */
    public IcPopupMenu(@NonNull Context context, @NonNull View anchor, int gravity) {
        ...
        mPopup.setOnDismissListener(new PopupWindow.OnDismissListener() {
            ...
            public void onDismiss() {
                if (mOnDismissListener != null) {
                    mOnDismissListener.onDismiss(IcPopupMenu.this);
                }
            }
        });
     ...
     * Example usage:
     * <pre>
     * IcPopupMenu myPopup = new IcPopupMenu(context, myAnchor);
    ...
    /**
     * Inflate a menu resource into this IcPopupMenu. This is equivalent to
    ...
    public interface OnDismissListener {
         ...
         */
        void onDismiss(IcPopupMenu menu);
    }
